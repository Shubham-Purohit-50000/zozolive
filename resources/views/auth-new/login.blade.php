...
<head>
    <meta charset="utf-8" />
    <title>ZOZO LIVE</title>
    <meta name="description" content="ZOZO LIVE | Login" />
    ...
    <link href="/assets/css/pages/login/login-2.min.css" rel="stylesheet" type="text/css" />
    <!--end::Page Custom Styles-->

    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="/assets/plugins/global/plugins.bundle.min.css" rel="stylesheet" type="text/css" />
    <link href="/assets/plugins/custom/prismjs/prismjs.bundle.min.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body"
            ...
            <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
                ...
                <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                    ...
                    <a href="#" class="text-center pt-2">
                        {{-- <img src="/logo.png" class="max-h-125px" alt=""/> --}}
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside body-->
                    <div class="d-flex flex-column-fluid flex-column flex-center">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_login_forgot_form" method="post"
                                ...
                                <div class="text-center pb-8">
                                    {{-- <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Forgotten
                                        Password ?</h2> --}}
                                    <p class="text-muted font-weight-bold font-size-h4">Enter your mobile to reset your
                                        password</p>
                                </div>
                                <!--end::Title-->
                                ...
                                <div class="form-group">
                                    <input
                                        class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6"
                                        type="text" placeholder="Mobile No." name="mobile" autocomplete="off" />
                                </div>
                                <!--end::Form group-->
                        ...
                        <!--end::Forgot-->
                        <!--begin::OTP-->
                        <div class="login-form login-otp pt-11">
                            <!--begin::Form-->
                            <form class="form" novalidate="novalidate" id="kt_login_otp_form"
                                action="javascript:void(0)" method="post">
                                @csrf
                                <!--begin::Title-->
                                <div class="text-center pb-8">
                                ...
                                <!--begin::Form group-->
                                <div class="form-group">
                                    <input type="hidden" name="user_id" id="user_id_otp">
                                    <input
                                        class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6"
                                        type="text" placeholder="Enter OTP " name="otp" autocomplete="off" />
                                </div>
                                <!--end::Form group-->

                                <!--begin::Form group-->
                                <div class="form-group d-flex flex-wrap flex-center pb-lg-0 pb-3">
                                    <button type="button" id="kt_login_otp_submit"
                                        class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Submit</button>
                                    <button type="button" id="kt_login_otp_cancel"
                                        class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Cancel</button>
                                </div>
                                <!--end::Form group-->
                            </form>
                        ...
                        <!--end::OTP-->
                        <!--begin::OTP-->
                        <div class="login-form login-newpass pt-11">
                            <!--begin::Form-->
                            <form class="form" novalidate="novalidate" id="kt_login_newpass_form"
                                action="javascript:void(0)" method="post">
                                @csrf
                                <!--begin::Title-->
                                <div class="text-center pb-8">
                                    <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Enter New
                                        Password</h2>
                                </div>
                                <!--end::Title-->
                                ...
                                <!--begin::Form group-->
                                <div class="form-group d-flex flex-wrap flex-center pb-lg-0 pb-3">
                                    <button type="button" id="kt_login_newpass_submit"
                                        class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Submit</button>
                                    <button type="button" id="kt_login_newpass_cancel"
                                        class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Cancel</button>
                                </div>
                                <!--end::Form group-->
                            </form>
    ...
    <path d="M10.1993 3.85336C12.1142 3.85336 13.406 4.66168 14.1425 5.33717L17.0207 2.59107C15.253 0.985496 12.9527 0 10.1993 0C6.2106 0 2.76588 2.23672 1.08887 5.49214L4.38626 7.99466C5.21352 5.59183 7.50242 3.85336 10.1993 3.85336Z" fill="#EB4335"/>
            ...
            <!--begin::Content-->
            <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #181c32;">
                <!--begin::Title-->
                <div
                    class="d-flex flex-column justify-content-center text-center pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
                    <h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;">ZOZO LIVE</h3>
    ...
    <script src="/assets/plugins/custom/prismjs/prismjs.bundle.min.js"></script>
