...
<script src="{{ asset('assets/plugins/custom/datatables/datatables.bundle.min.js?v=7.0.6') }}"></script>
<script src="{{ asset('assets/js/pages/crud/datatables/extensions/buttons.min.js?v=7.0.6') }}"></script>
