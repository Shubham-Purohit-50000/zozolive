...
<head>
    ...
    <meta content="ZOZO Chat" name="description" />
...
<body
    ...
    <div class="header-mobile align-items-center header-mobile-fixed " id="kt_header_mobile">
        <!--begin::Logo-->
        <a href="/dashboard" style="margin: 0px; padding: 0px;">
            {{-- <img alt="Logo" src="{{ asset('logo.svg') }}" id="brand-logo"> --}}
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column " id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a class="text-dark-75 text-hover-primary" style="letter-spacing: 1px"
                                href="https://teacoders.in" target="_blank">
                                Teacoders
                            </a>
                        </div>
                        <!--end::Copyright-->
                        ...
                        <div class="nav nav-dark">
                            {{-- <a class="nav-link pl-0 pr-5" href="#" target="_blank">
                                    Terms & Conditions
                                </a>
                                <a class="nav-link pl-0 pr-5" href="#" target="_blank">
                                    Privacy Policy
                                </a> --}}
                            {{-- <a class="nav-link pl-0 pr-0" href="https://vnailweb.com" target="_blank">
                                    Contact
                                </a> --}}
                        </div>
                        <!--end::Nav-->
    ...
    <div class="offcanvas offcanvas-right p-10" id="kt_quick_user">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
            ...
            <a class="btn btn-xs btn-icon btn-light btn-hover-primary" href="#" id="kt_quick_user_close">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label bg-success text-white h1"
                        style="background-image:url('{{ Storage::url(auth()->user()->avatar) }}')">
                        {{-- {{ Auth::user()->name[0] }} --}}
                ...
                <div class="d-flex flex-column">
                    <a class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary" href="#">
                        {{ Auth::user()->name }}
                    </a>
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a class="navi-item" href="{{ url('update-profile') }}">
                    <div class="navi-link">
        ...
        <span class="svg-icon">
            ...
            <svg height="24px" version="1.1" viewbox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg"
                ...
                <g fill="none" fill-rule="evenodd" stroke="none" stroke-width="1">
                    ...
                    <rect fill="#000000" height="10" opacity="0.3" rx="1" width="2" x="11" y="10">
                    </rect>
                    <path
