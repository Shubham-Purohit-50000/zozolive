...
var KTDropzoneDemo = function () {
    ...
    var demo1 = function () {
        ...
        $('#kt_dropzone_1').dropzone({
            url: "/apk-upload", // Set the url for your upload script location
            paramName: "apk", // The name that will be used to transfer the file
            maxFiles: 1,
            maxFilesize: 500, // MB
            addRemoveLinks: true,
            acceptedFiles: ".apk",
            ...
            complete: function(file) {
                if(file.status == 'success'){
                    document.getElementById('apk').value = file.xhr.response;
                }
